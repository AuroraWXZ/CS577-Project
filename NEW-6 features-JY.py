...
def train_and_evaluate(feature, label_dict, tokenizer, max_len, device):
    ...
    # Training loop
    for epoch in range(5):  # Reduced number of epochs for brevity
        model.train()
...
features = {
    ...
    "TRAFFIC_CONTROL_DEVICE": {"NO CONTROLS": 0, "NO PASSING": 1, "OTHER": 2, "OTHER WARNING SIGN": 3, "RAILROAD CROSSING GATE": 4, "STOP SIGN/FLASHER": 5, "TRAFFIC SIGNAL": 6, "UNKNOWN": 7, "YIELD": 8},
    "POSTED_SPEED_LIMIT": {
    "0": 0, "5": 1, "10": 2, 
    "15": 3, "20": 4, "25": 5, 
